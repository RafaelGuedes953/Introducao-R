...
# 2. Imprime essas estatísticas em texto para qu e você possa colar isso em outro lugar
...
# definindo valor para a meta
calcula_estatisticas_descritivas(base_de_dados, "atraso_saida", meta = 15)
